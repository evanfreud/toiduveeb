...
--
-- Host: 127.0.0.1
-- Loomise aeg: Aprill 19, 2017 kell 01:16 PM
...
--
-- Tabeli struktuur tabelile `deliveries`
--
...
--
-- Tabeli struktuur tabelile `ostukorv`
--
...
--
-- Tabeli struktuur tabelile `products_to_scart`
--
...
--
-- Tabeli struktuur tabelile `scart`
--
...
--
-- Indeksid tabelile `products_to_scart`
--
...
--
-- Indeksid tabelile `region`
--
ALTER TABLE `region`
  ADD PRIMARY KEY (`id_region`);

--
-- Indeksid tabelile `scart`
--
ALTER TABLE `scart`
